...
async function seed() {
  ...
  const productPayload = {
    ...
    short_description: 'Tiện ích Chrome tự động hóa học Coursera đỉnh cao: Auto Skip Video, đánh dấu hoàn thành Reading và Tự động giải Quiz hỗ trợ AI thông minh. Tiết kiệm 95% thời gian học tập mà vẫn nắm chắc chứng chỉ.',
  ...
  const demoPayload = {
    ...
    code_preview_snippet: [
      ...
      '// Bản quyền chính chủ: Tuấn và Quân FPT UNIVERSITY',
      ...
      '    if (!isValid) throw new Error("License không hợp lệ!");',
      '    this.isActive = true;',
      '    console.log("🚀 Coursera Skip VIP Activated: Permanent License.");',
    ...
    features_list: [
      ...
      'Tự động kích hoạt bản quyền vĩnh viễn (CSR-PERM) gắn theo email',
