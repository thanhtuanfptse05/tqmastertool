<!-- converted from J1.S.P0061 - Shape.docx -->
...
Calculate the area of ​​a triangle using the formula Heron:

Use Math.sqrt()
Calculate the area of ​​a circle with Pi = Math.PI
Function 1: Calculate the perimeter
Must create function: public double getPerimeter ()
Return: the perimeter of the shape.
Function 2: Calculate the area.
Must create function: public double getArea ()
Return: The area of ​​the shape.
Function 3: Display the shape information.
Must create the function: public void printResult ()
Return: void.

| LAB211 Assignment | Type: | Short Assignment |
| --- | --- | --- |
| LAB211 Assignment | Code: | J1.S.P0061 |
| LAB211 Assignment | LOC: | 42 |
