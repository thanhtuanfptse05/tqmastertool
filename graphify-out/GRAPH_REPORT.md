...
- `HomePage()` --calls--> `useStore()`  [EXTRACTED]
  src/app/page.tsx → src/lib/store.tsx
...
- `AdminOrdersPage()` --calls--> `extractOrderLicenseInfo()`  [EXTRACTED]
  src/app/admin/orders/page.tsx → src/lib/coursera-keygen.ts
- `AdminOrdersPage()` --calls--> `parseLicenseKeyDuration()`  [EXTRACTED]
  src/app/admin/orders/page.tsx → src/lib/coursera-keygen.ts
...
Cohesion: 0.03
Nodes (18): containsPoint(), Ct(), getAverageFrequency(), getFrequencyData(), _initMemoryManager(), i(), Nt(), Ot() (+10 more)
...
### Community 3 - "bs"
Cohesion: 0.06
Nodes (13): bs, clone(), cn, G(), getParameter(), hn, lc, Qi() (+5 more)
...
### Community 14 - "Mi"
Cohesion: 0.06
Nodes (10): _a(), bi, bl, fl(), Ga, Mi, ol(), ra (+2 more)

### Community 15 - "zi"
Cohesion: 0.07
Nodes (11): applyMatrix4(), Dh(), Io, lo, ml(), Po, tl(), translate() (+3 more)

### Community 16 - "Ue"
Cohesion: 0.05
Nodes (5): Ca, ds(), Ue, updateMatrixWorld(), B()
...
### Community 19 - "kn"
Cohesion: 0.11
Nodes (12): f(), dispose(), Gn(), Ji, jn(), kn, j(), ne (+4 more)

### Community 20 - "load"
Cohesion: 0.11
Nodes (11): hc, load(), c(), loadAsync(), ls(), mc, Oc, parseImages() (+3 more)

### Community 21 - "store.tsx"
Cohesion: 0.13
Nodes (25): HomePage(), AdminOrderEditModalProps, OrderDetailModalProps, ProductCard(), ProductCardProps, CourseraLicenseItem, INITIAL_ORDERS, INITIAL_PRODUCTS (+17 more)

### Community 22 - "isEmpty"
Cohesion: 0.11
Nodes (9): expandByPoint(), expandByScalar(), getCenter(), getSize(), isEmpty(), makeEmpty(), setFromPoints(), setLength() (+1 more)

### Community 23 - "an"
Cohesion: 0.08
Nodes (15): an, g(), x(), y(), Cc, cs(), en(), os() (+7 more)

### Community 25 - ".dispatchEvent"
Cohesion: 0.13
Nodes (6): disconnect(), remove(), ta, D(), N(), O()
...
Cohesion: 0.13
Nodes (29): lucide-react, react, AdminLayout(), AdminOrdersPage(), AdminDashboardPage(), ChartTimeframe, groupOrdersByTimeframe(), thinLabels() (+21 more)
...
Cohesion: 0.09
Nodes (13): add(), d(), u(), At(), closestPointToPoint(), constructor(), delta(), E() (+5 more)

### Community 31 - "ao"
Cohesion: 0.08
Nodes (4): ao, bo, Eo, Mo

### Community 33 - ".fromJSON"
Cohesion: 0.20
Nodes (11): bindSkeletons(), gl, parse(), parseAnimations(), parseAsync(), parseGeometries(), parseMaterials(), parseShapes() (+3 more)
...
### Community 36 - "n"
Cohesion: 0.09
Nodes (29): m(), a(), jo(), At(), Ut(), r(), o(), c() (+21 more)
...
### Community 58 - "i"
Cohesion: 0.14
Nodes (7): p(), closestPointToPointParameter(), _i, i(), toShapes(), xn(), r()
...
### Community 61 - ".raycast"
Cohesion: 0.15
Nodes (4): Dt(), Ki(), ro(), setFromCamera()
...
### Community 63 - "mn"
Cohesion: 0.10
Nodes (4): distanceToPoint(), ln, c(), mn

### Community 64 - "sc"
Cohesion: 0.13
Nodes (5): ac(), jl(), sc, tc, wh()
...
### Community 68 - "Feature Specification: Phương Thức Thanh Toán Kép (Quét Mã VietQR Tự Động & Tải Ảnh Bill Dự Phòng Cho Admin Duyệt)"
Cohesion: 0.17
Nodes (11): Edge Cases, Feature Specification: Phương Thức Thanh Toán Kép (Quét Mã VietQR Tự Động & Tải Ảnh Bill Dự Phòng Cho Admin Duyệt), Functional Requirements, Key Entities, Measurable Outcomes, Requirements *(mandatory)*, Success Criteria *(mandatory)*, User Scenarios & Testing *(mandatory)* (+3 more)
...
### Community 76 - "parseObject"
Cohesion: 0.15
Nodes (4): ba, bc, Ja, parseObject()
...
### Community 78 - "nl"
Cohesion: 0.09
Nodes (10): el(), il(), ko, ll(), nl(), _o, rl(), sl() (+2 more)
...
### Community 107 - "ProductDetailModal.tsx"
Cohesion: 0.24
Nodes (7): LAB_DEMOS, LabConsoleDemo, NetBeansConsoleSimulator(), ProductDescriptionRenderer(), ProductDescriptionRendererProps, ProductDetailModal(), ProductDetailModalProps
...
### Community 158 - "Task"
Cohesion: 0.06
Nodes (6): java.text.SimpleDateFormat, InputValidator, Main, Task, TaskController, TaskView
...
Cohesion: 0.20
Nodes (20): dynamic, GET(), dynamic, PATCH(), POST(), dynamic, POST(), SePayWebhookBody (+12 more)
...
## Knowledge Gaps
- **1476 isolated node(s):** `nextConfig`, `name`, `version`, `private`, `dev` (+1471 more)
...
- **Why does `oe` connect `oe` to `three.min.js`, `ks`, `he`, `Ce`, `Mi`, `zi`, `Ue`, `kn`, `isEmpty`, `.toArray`, `constructor`, `ao`, `ae`, `Xe`, `n`, `Ti`, `.setAttribute`, `setValue`, `.fromArray`, `ic`, `i`, `.raycast`, `sc`, `.parse`?**
  _High betweenness centrality (0.014) - this node is a cross-community bridge._
- **Why does `he` connect `he` to `three.min.js`, `equals`, `zi`, `.getX`, `isEmpty`, `copy`, `constructor`?**
